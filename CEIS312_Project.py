# matplotlib is used to create static, animated, and interactive visualizations
import matplotlib
# panda is used with data sets, it functions is to analyze, clean, explore, and manipulate data.   
import pandas as pd 
# numpy is use to perform a wide variety of mathematical operations on arrays.
""" adds powerful data structures to python that guarantee efficient calculations with arrays and matrices and it 
supplies an enormous library of high-level mathematical functions that operate on these arrays and matrices"""
import numpy as np 
# matplotlib(ext: pyplot library) is use for data visualization and its function is to form plots, on graphs and charts.
